    ...
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-[#16A34A] mt-2">{kpis.scheduled}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-[#DC2626] mt-2">{kpis.absentLate}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-[#D97706] mt-2">{kpis.plannedLeave}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border col-span-2 md:col-span-1">
          ...
          <div className="text-xl font-bold text-[#DC2626] mt-2">{kpis.outShrinkage}%</div>
        </Card>
      </div>
