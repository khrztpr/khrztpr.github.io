    ...
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-status.successBase mt-2">{kpis.scheduled}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-status.errorBase mt-2">{kpis.absentLate}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border">
          ...
          <div className="text-xl font-bold text-status.warningBase mt-2">{kpis.plannedLeave}</div>
        </Card>
        ...
        <Card className="bg-neutral.card p-4 rounded-xl shadow-sm border border-neutral.border col-span-2 md:col-span-1">
          ...
          <div className="text-xl font-bold text-status.errorBase mt-2">{kpis.outShrinkage}%</div>
        </Card>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-status-success-softBackground p-4 rounded-xl border border-status-success-softBackground/50">
          <div className="text-status.successTextPrimary text-[11px] font-bold uppercase tracking-wider flex items-center gap-1">
            <Users size={13} /> Active Logged (Avg)
          </div>

          <div className="text-xl font-bold text-status.successBase mt-1">{kpis.active}</div>
